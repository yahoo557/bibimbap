...
router.post('/blog', (req, res) => {
    const searchQuery = "SELECT a.blogname, a.blog_id, b.nickname FROM blog AS a INNER JOIN users AS b ON a.blogname LIKE '%' || $1 || '%' AND a.user_id = b.user_id";
...
router.post('/nickname', (req, res) => {
    const searchQuery = "SELECT a.blogname, a.blog_id, b.nickname FROM blog AS a INNER JOIN users AS b ON b.nickname LIKE '%' || $1 || '%' AND a.user_id = b.user_id";
